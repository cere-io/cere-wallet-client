...
export const API_BASE_URL = 'https://customer-payment-service.stage.cere.io';
export const COINGECKO_API_URL =
  process.env.REACT_APP_COINGECKO_API_URL ||
  'https://api.coingecko.com/api/v3/simple/price?ids=cere-network&vs_currencies=usd';
